classdef MatlabTestBench
    ...
    properties (Access = private)
        ...
        NumOutputSamples % Number of output samples - must be a multiple of Parallelism
    ...
    methods
        ...
        function obj = generateTestVectors(obj)
            ...
            if strcmp(obj.SignalType, 'chirp')
                obj = plotSpectrogram(obj);
            end
            if strcmp(obj.SignalType, 'complex_exp')
...
methods (Access = private)
    ...
    function obj = setTestCase(obj)
        ...
        if strcmp(obj.SignalType, 'chirp')
            obj.NumOutputSamples = 1024;
        elseif strcmp(obj.SignalType, 'complex_exp')
            obj.NumOutputSamples = 128;
        elseif strcmp(obj.SignalType, 'random')
    ...
    function obj = generateInput(obj)
        ...
        switch s
            case 'chirp'
                phi = 0;
                input = obj.Amplitude * chirp(t, obj.SignalBandwidth(1), obj.SignalDuration, obj.SignalBandwidth(2), 'linear', phi, 'complex');
            case 'complex_exp'
